...
/* package agents-0.1.0.0 */
#ifndef VERSION_agents
#define VERSION_agents "0.1.0.0"
#endif /* VERSION_agents */
#ifndef MIN_VERSION_agents
#define MIN_VERSION_agents(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_agents */
...
#define CURRENT_COMPONENT_ID "agents-0.1.0.0-9WRHshTcMKxHRgBlC2nDFA-agents"
